...
function renderProductList(selectedList) {
    ...
    for (let i in selectedList) {
        ...
        <div class="product-item">
            <img src="${selectedList[i].image}" alt="">
...
// Hàm tìm kiếm sản phẩm cơ bản

function searchProduct(searchString, selectedList){
    let productFilter = selectedList.filter(function(product){
        return product.name.toLowerCase().includes(searchString.toLowerCase());
    })

    renderProductList(productFilter);
}
